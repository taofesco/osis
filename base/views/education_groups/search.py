...
from base.business.education_groups.administrative_data import get_administrative_data
...
def education_groups(request):
    ...
    if request.GET.get('xls_status') == "xls_administrative":
        return create_xls_administrative_data(request.user, get_administrative_data(object_list),
